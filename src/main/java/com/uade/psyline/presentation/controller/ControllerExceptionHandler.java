...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<ApiError> typeMismatch(MethodArgumentTypeMismatchException e) {
        var errMsg = "The required type for '" + e.getName() + "' should be '" + e.getRequiredType().getName()
                + "' but found '" + e.getValue() + "'";
        return new ResponseEntity<>(new ApiError("Type mismatch", errMsg, HttpStatus.BAD_REQUEST.value()),
